<template>
    ...
    <v-row>
        <v-col cols=12>
            <p class="ma-0 title">འོས་སྦྱོར།</p>
        </v-col>
    ...
    <v-row>
        <v-col cols=12>
            ...
            <p class="ma-0 title">དཔེ་དེབ་གསར་བ།</p>
        </v-col>
        <v-col cols=12>
    ...
    <v-row>
        <v-col cols=12>
            <v-divider class="new-legend"></v-divider>
            <p class="ma-0 title">རིགས་བཀར་རྣམ་གྲངས།</p>
        </v-col>
...
export default {
    ...
    created() {
        ...
        this.navs = [
            { icon: 'widgets',            href:'/nav',       text: 'རིགས་བཀར་ས་མིག',  count: this.$store.state.sys.books      },
            { icon: 'mdi-human-greeting', href:'/author',    text: 'མཛད་པ་པོ།',     count: this.$store.state.sys.authors    },
            { icon: 'mdi-home-group',     href:'/publisher', text: 'པར་ཁང་།出版社',   count: this.$store.state.sys.publishers },
            { icon: 'mdi-tag-heart',      href:'/tag',       text: 'རྟགས་བྱང་།',     count: this.$store.state.sys.tags       },
            { icon: 'mdi-history',        href:'/recent',    text: 'དཔེ་དེབ་ཆ་ཚང་།', },
